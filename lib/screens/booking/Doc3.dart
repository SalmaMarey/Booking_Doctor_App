...
class Doc3Page extends StatefulWidget {
  Doc3Page({Key? key}) : super(key: key);

  @override
  State<Doc3Page> createState() => _Doc3PageState();
}

class _Doc3PageState extends State<Doc3Page> {
  List<QueryDocumentSnapshot<Object?>> Doc3List = [];
  @override
  void initState() {
    super.initState();
    getDoc3();
  ...
  getDoc3() async {
    CollectionReference Doc3 = FirebaseFirestore.instance.collection('Doc3');
    QuerySnapshot data = await Doc3.get();
    Doc3List = data.docs;
    loading = false;
    setState(() {});
  }
  ...
  AddBook3(
    ...
    if (_formKey.currentState!.validate()) {
      ...
      setState(() {});
      try {
        CollectionReference Book3 =
            FirebaseFirestore.instance.collection('Book3');
        await Book3.add(
          {
